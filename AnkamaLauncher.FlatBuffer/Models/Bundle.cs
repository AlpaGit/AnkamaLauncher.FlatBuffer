...
public struct Bundle : IFlatbufferObject
{
  ...
  public Chunk? Chunks(int j) { int o = __p.__offset(6); return o != 0 ? (Chunk?)(new Chunk()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int ChunksLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<Bundle> CreateBundle(FlatBufferBuilder builder,
  ...
  public static Offset<Bundle> EndBundle(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Bundle>(o);
  }
  ...
  public static Offset<Bundle> Pack(FlatBufferBuilder builder, BundleT _o) {
    if (_o == null) return default(Offset<Bundle>);
